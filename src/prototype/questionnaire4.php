...
<html lang="en">
  <head>
    ...
    <title>NHS || Questionnaire 4</title>
  </head>
  <body>
...
<div class="content" style="margin-top:20px;">
    <h1>Questionnaire 4 - Professional Compromise</h1>
    <p style="margin-bottom:100px;">In your opinion, how often do staff in the Trust meet the following problems in carrying out their work?  </p>

    <form id="questionnaire4" method="POST" action="insertanswers.php">
      <!--questionnaire no-->
      <input
        id="questionnaire_no"
      ...
      <section id="question1">
        <p>1. Having to make trade-offs between quality of patient care and cost savings. </p>
      ...
      <section id="question2">
        <p>2. Lack of clarity/agreement about the different responsibilities of doctors and nurses. </p>
      ...
      <section id="question3">
        <p>3. Being unable to achieve quality in their work because there are staff shortages.</p>
      ...
      <section id="question4">
        <p>4. Having to do an acceptable minimum of work rather than doing the best quality work possible. </p>
