...
<html lang="en">
  <head>
    ...
    <title>NHS || Questionnaire 5</title>
  </head>
  <body>
...
<div class="container">
  <div class="nav"><h2 style="font-size: 30px;font-weight:500;line-height:1.1;margin-top: 20px;margin-bottom: 10px;">Monthly Mental Health Survey</h2>
    ...
    <h1>Questionnaire 5 - Role Clarity</h1>
    <p style="margin-bottom:100px;">How true are the following of your job? </p>

    <form id="questionnaire5" method="POST" action="insertanswers.php">
      <!--questionnaire no-->
      <input
        id="questionnaire_no"
      ...
      <section id="question1">
        <p>1. I have clear planned goals and objectives for my job. </p>
      ...
      <section id="question2">
        <p>2. I know that I have divided my time properly.</p>
      ...
      <section id="question3">
        <p>3. I know what my responsibilities are.</p>
      ...
      <section id="question4">
        <p>4. Explanation is clear of what has to be done. </p>
      ...
      <section id="question5">
        <p>5. I know exactly what is expected of me. </p>

        <input type="radio" id="q5_1" name="q5" value="1" style="width:auto; display:inline-block;"/>
        <label for="q5_1">1</label>

        <input type="radio" id="q5_2" name="q5" value="2" style="width:auto; display:inline-block;"/>
        <label for="q5_2">2</label>

        <input type="radio" id="q5_3" name="q5" value="3" style="width:auto; display:inline-block;"/>
        <label for="q5_3">3</label>

        <input type="radio" id="q5_4" name="q5" value="4" style="width:auto; display:inline-block;"/>
        <label for="q5_4">4</label>

        <input type="radio" id="q5_5" name="q5" value="5" style="width:auto; display:inline-block;"/>
