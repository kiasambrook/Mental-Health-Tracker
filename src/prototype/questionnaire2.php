...
<html lang="en">
  <head>
    ...
    <title>NHS || Questionnaire 2</title>
  </head>
  <body>
...
<div class="content" style="margin-top:20px;">
    <h1>Questionnaire 2 - Influence over decisions</h1>
    <p style="margin-bottom:100px;">The questions below concern the influence you have over decisions at work. </p>
    <p>To what extent: </p>

    <form id="questionnaire2" method="POST" action="insertanswers.php">
      <!--questionnaire no-->
      <input
        id="questionnaire_no"
      ...
      <section id="question1">
        <p>1. Can you influence what goes on in your work area as a whole?</p>
      ...
      <section id="question2">
        <p>2. Does your immediate superior ask for your opinion before making decisions affecting your work? </p>
      ...
      <section id="question3">
        <p>3. Do you have the opportunity to contribute to meetings on new work developments?</p>
      ...
      <section id="question4">
        <p>4. Are you allowed to participate in decisions which affect you?</p>
